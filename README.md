...
## 功能特性详解
### 1. 图形界面功能
- **实时数据展示**：支持实时显示爬取进度和结果
- **交互式操作**：提供直观的按钮和输入控件
- **数据源测试**：可快速测试各数据源的可用性
- **时间范围选择**：支持自定义爬取时间范围
- **多格式导出**：支持导出为多种格式
- **现代化设计**：科技感UI设计，良好的用户体验

### 2. 报告查看器功能
- **路径自定义**：支持选择不同的报告目录
- **多报告切换**：可快速切换查看不同时间段的报告
- **智能搜索**：支持按CVE ID和漏洞名称搜索
- **多维度筛选**：支持按严重程度、来源等条件筛选
- **详细信息展示**：提供完整的漏洞详细信息
- **统计信息**：显示漏洞数量、严重程度分布等统计信息
...
### Q: 图形界面无法启动？
A: 检查是否安装了PyQt6依赖，运行`pip install PyQt6`进行安装。

### Q: 如何自定义报告查看器的报告路径？
A: 在报告查看器界面中，点击"浏览"按钮选择报告目录即可。
...
感谢原开源项目作者提供的优秀基础代码，本项目在此基础上进行了功能扩展和界面优化。

## 联系方式
- 问题反馈：通过GitHub Issues提交
- 技术讨论：欢迎在Issues中进行技术交流
